...
/**
 * Created by jocye on 2016-06-23.
 */
public class StopLossDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.stop_loss_dialog, null);

        final RecyclerView weightsView = (RecyclerView) rootView.findViewById(R.id.stop_loss_weights_list);
        final EditText strikeView = (EditText) rootView.findViewById(R.id.stop_loss_strike_input);
        ...
        builder.setView(rootView)
                ...
                .setNegativeButton(R.string.cancel_simulation, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        // Cancel
                        mSimulation.delete();
                        StopLossDialogFragment.this.getDialog().cancel();
                    }
                });
