 ...
 */
public class ConstantProportionsDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.constant_proportions_dialog, null);
        ...
        builder.setView(rootView)
                ...
                .setNegativeButton(R.string.cancel_simulation, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        // Cancel
                        mSimulation.delete();
                        ConstantProportionsDialogFragment.this.getDialog().cancel();
                    }
                });
